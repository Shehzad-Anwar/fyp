        ...
        <div className="container py-2 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              ...
              src={
                Product.img.length < 35 && Product.img != ""
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                <div className="flex">
                  ...
                  <button
                    style={{
                      backgroundColor:
                        Product.color.length > 3 ? Product.color : "indigo",
                    }}
                ...
                <div className="flex ml-6 items-center">
                  ...
                  <div className="relative">
                    <button
                      className={`border-2 border-gray-300 ml-1 bg-gray-200 rounded-lg text-sm font-sati font-bold px-2 w-auto h-8 focus:outline-none`}
                    >
                      {" "}
              ...
              <div className="flex">
                <span className="title-font font-medium text-2xl text-gray-900">
                  PKR : {Product.price ? Product.price : "59.00"}
                </span>
