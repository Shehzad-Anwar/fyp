...
const UpdateProducts = ({ product, Check, ...props }) => {
  if (Check == false) {
    console.log(Check);
    ...
    const onUpdate = async (e) => {
      ...
      if (
        ...
        if (response.status == true) {
          toast.success(`${Product.title}, successfully Updated.`, {
            position: "top-center",
            autoClose: 1000,
            hideProgressBar: false,
            closeOnClick: true,
          ...
          toast.error(`Fail to Updated, ${Product.title}.`, {
            position: "top-center",
            autoClose: 1000,
            hideProgressBar: false,
            closeOnClick: true,
